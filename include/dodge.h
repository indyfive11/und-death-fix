...
public:
	...
	void RegisterforUpdate(RE::Actor* a_actor, std::tuple<float, std::chrono::steady_clock::time_point, std::chrono::milliseconds, std::string> data);
...
protected:
	...
	std::unordered_map<RE::Actor*, std::vector<std::tuple<float, std::chrono::steady_clock::time_point, std::chrono::milliseconds, std::string>>> _Timer;
